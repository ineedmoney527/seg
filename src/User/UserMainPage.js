...
function SwipeableTextMobileStepper({ books,handleViewBookClick }) {
    ...
    return (
        <Box sx={{ width:'100%',display: 'flex', flexDirection: 'column' }}>
                            ...
                            <Box sx={{
                                ...
                                <Box sx={{
                                    ...
                                    <Box
                                        ...
                                        // alt={step.label}
                                    />
                                    <Box sx={{ display: 'flex', flexDirection: 'column',marginRight:'auto',width:'70%' }}>
                                        <Typography sx={{fontWeight:'Bold',fontSize:'15px'}}>{step.title}</Typography>
            ...
            <MobileStepper
                sx={{backgroundColor:'transparent',alignSelf: 'center', // Align the MobileStepper in the center horizontally
...
export default function UserMainPage() {
    ...
    return (
        ...
        >
            ...
            <SwipeableTextMobileStepper books={books} handleViewBookClick={handleViewBookClick} />
            ...
            <Box sx={{width:'80%',height:'100px',backgroundColor:'white',display:"flex",marginLeft:'auto',marginBottom:'50px',marginRight:'auto',boxShadow: "0 2px 4px rgba(0, 0, 0, 0.5)",paddingLeft:'10px',borderRadius:'5px'}}>
                <Typography sx={{display: 'flex', flexDirection: 'column'}}>
                    <label style={{fontWeight: 'bold', fontSize: '30px',color:'#565656'}}>
                        UOS Library
                    </label>
                    <Box sx={{display:'flex',flexDirection:'row'}}>
