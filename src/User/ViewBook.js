    ...
    return (
        ...
        >
            <Box sx={{
                ...
                <Box>
                    <Typography sx={{fontSize:'25px',fontWeight:'Bold',fontFamily:'Alata'}} gutterBottom>
                        {book.title}
                    </Typography>
                ...
                <Box sx={{marginTop:'auto',marginBottom:'auto',display:'flex',flexDirection:'column',marginLeft:'auto'}}>
                    <img src={book.imgPath} alt={'book-cover'} style={{width:'120px', height:'200px'}} />
                    {!reserved && (
                        <button
            ...
            <Box>
                <label style={{display:'flex',width:'80%', fontWeight:'Bold',marginLeft:'auto',
                    marginRight:'auto',marginTop:'80px',fontSize:'18px',fontFamily:'Alata'
                        ...
                        >
                            <Box sx={{marginLeft:'10px'}}>
                                <Box sx={{display:'flex',flexDirection:'row'}}>
                                    <img src={review.image} alt={"review-icon"} style={{width:'25px',height:'25px'}}/>
                                    <label style={{
                                        wordWrap: 'break-word',
                                ...
                                <Box sx={{display: 'flex', alignItems: 'center'}}>
                                    <Typography variant="body2"
                                                sx={{ marginRight: '5px'}}>Rating:</Typography>
