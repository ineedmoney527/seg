...
function Request(){
    ...
    const [requestBook, setRequestBook] = useState([
        {
            ...
            publishedYear: 2016,
            requestDate: '2024-04-15', // Renamed from startDatetime
        ...
        },
        {
            ...
            publisher: 'Scribner',
            publishedYear: 1925,
            requestDate: '2024-04-20', // Renamed from startDatetime
        ...
        },
        {
            ...
            publishedYear: 1960,
            requestDate: '2024-04-18', // Renamed from startDatetime
    ...
    const columns = [
        { field: 'studentId', headerName: 'Student ID', flex: 1,headerAlign: "center",  filterable: true },
        { field: 'bookCode', headerName: 'Book Code', flex: 1 ,headerAlign: "center",  filterable: true},
        { field: 'title', headerName: 'Title', flex: 1 ,headerAlign: "center",  filterable: true},
        { field: 'author', headerName: 'Author', flex: 1 ,headerAlign: "center",  filterable: true},
        { field: 'edition', headerName: 'Edition', flex: 1 ,headerAlign: "center", filterable: true},
        { field: 'publisher', headerName: 'Publisher', flex: 1 ,headerAlign: "center", filterable: true},
        { field: 'publishedYear', headerName: 'Published Year', flex: 1 ,headerAlign: "center", filterable: true},
        { field: 'requestDate', headerName: 'Request Date', flex: 1 ,headerAlign: "center", filterable: true},
        { field: 'status', headerName: 'Status', flex: 1 ,headerAlign: "center", filterable: true},
    ];
    ...
    const renderTable = () => {
        return (
            <div style={{ height: '73vh', width: '100%' }}>
                <StyledDataGrid
                    rows={requestBook.filter((book) => {
                        if (selectedOption === 'requesting') {
                            return book.status === 'pending';
                        } else if (selectedOption === 'history') {
                            return book.status === 'approved' || book.status === 'rejected';
                        }
                        return false;
                    })}
                    columns={columns}
                    ...
                    onSelectionModelChange={(selection) => {
                        setSelectedRow(requestBook.find((row) => row.id === selection.selectionModel[0]) || null);
                    }}
    ...
    return (
        ...
        >
            ...
            >
                <Box sx={{ width: '300px' }}>
                    <form onSubmit={handleSubmit(onSubmit)} className="form-containerRequest">
                        <TextField
                ...
                <Stack direction="row" spacing={3} justifyContent="space-between">
                    <Stack direction="row" spacing={0.3}>
                        <Button onClick={() => handleOptionClick('requesting')}
